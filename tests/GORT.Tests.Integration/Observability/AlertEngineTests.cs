using GORT.Core;
using global::GORT.Observability.Alerts;
...
public sealed class AlertEngineTests
{
    ...
    private static AlertEngine CreateEngine(IEnumerable<global::GORT.Observability.Alerts.Notifiers.INotifier> notifiers)
    {
    ...
    private sealed class FailingNotifier : global::GORT.Observability.Alerts.Notifiers.INotifier
    {
