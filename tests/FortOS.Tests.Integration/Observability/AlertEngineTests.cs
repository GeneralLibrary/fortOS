using FortOS.Core;
using global::FortOS.Observability.Alerts;
...
public sealed class AlertEngineTests
{
    ...
    private static AlertEngine CreateEngine(IEnumerable<global::FortOS.Observability.Alerts.Notifiers.INotifier> notifiers)
    {
    ...
    private sealed class FailingNotifier : global::FortOS.Observability.Alerts.Notifiers.INotifier
    {
