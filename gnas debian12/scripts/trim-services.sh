#!/usr/bin/env bash
# =============================================================================
# GNAS Debian 12 — Service Trimming Script
# =============================================================================
# Runs INSIDE the chroot during debootstrap.
# Disables/masks ALL services except those GNAS requires.
# =============================================================================
set -euo pipefail

echo "=== GNAS Service Trimming ==="
...
# -----------------------------------------------------------------------------
# 6. CREATE GNAS BOOT MARKER
# -----------------------------------------------------------------------------
cat > /etc/gnas/trimmed-release << 'EOF'
GNAS Debian 12 — Trimmed Build
===============================
This Debian 12 rootfs has been trimmed for GNAS.
Only services required by GNAS are enabled.
Build date: BUILD_DATE_PLACEHOLDER
See /etc/gnas/enabled-services.conf for the keep list.
EOF
