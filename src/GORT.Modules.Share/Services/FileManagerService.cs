...
public sealed partial class FileManagerService
{
    ...
    /// </summary>
    public FileManagerService(IGortConfiguration? configuration = null, ShareModule? shareModule = null, IProcessManager? processManager = null, IDatabaseProvider? database = null)
    {
    ...
    {
        var value = Environment.GetEnvironmentVariable("GORT_DATA_ROOT");
