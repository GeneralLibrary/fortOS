...
using GORT.Core;
using GORT.Observability.Logging.Stages;
...
public sealed class LogPipeline : ILogPipeline, IHostedService, IAsyncDisposable
{
    ...
    public LogPipeline(IEnumerable<ILogStore> stores, IGortConfiguration? configuration = null, IAuditChain? auditChain = null, ILogger<LogPipeline>? logger = null)
    {
        _logger = logger;
