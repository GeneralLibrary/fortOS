...
/// <summary>Sink that routes Serilog events into the GORT log pipeline.</summary>
public sealed class GortSerilogSink : ILogEventSink
{
    private readonly ILogPipeline _pipeline;

    /// <summary>Initialize Serilog sink.</summary>
    public GortSerilogSink(ILogPipeline pipeline)
    {
        _pipeline = pipeline;
    }
