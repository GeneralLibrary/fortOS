...
namespace GORT.Observability.Alerts.Notifiers;
...
public sealed class WebhookNotifier : INotifier
{
    ...
    public WebhookNotifier(IGortConfiguration configuration, HttpClient? httpClient = null, ILogger<WebhookNotifier>? logger = null)
    {
