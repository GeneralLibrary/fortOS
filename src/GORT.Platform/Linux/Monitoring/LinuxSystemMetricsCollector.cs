...
namespace GORT.Platform.Linux.Monitoring;
...
public sealed class LinuxSystemMetricsCollector : ISystemMetricsCollector
{
    ...
    [
        "gort.service", "docker.service", "containerd.service", "smbd.service",
    ...
    public LinuxSystemMetricsCollector(IDiskManager diskManager, IGortConfiguration configuration, ILogger<LinuxSystemMetricsCollector> logger)
    {
    ...
    private Task<CommandResult> ExecuteHostCommandAsync(string fileName, string arguments, CancellationToken ct, TimeSpan timeout)
    {
        ...
        // makes systemd, Docker, and socket inspection describe the NAS host rather than GORT itself.
