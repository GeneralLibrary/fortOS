...
internal static class PageHelpers
{
    ...
    public static Panel Error(Exception ex) => new(Markup.Escape(ex is FortOSApiException ? ex.Message : "Connection failed: " + ex.Message)) { Header = new PanelHeader("Error") };
}
