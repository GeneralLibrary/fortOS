...
public static class RecycleCommand
{
    ...
    public static Command Create(CliOptions options)
    {
        ...
        Command AddShareCommand(string name, string desc, Func<ParseResult, FortOS.Cli.ApiClient.FortOSApiClient, CancellationToken, Task<System.Text.Json.JsonDocument>> action)
        {
