...
namespace GORT.Api.Controllers;

/// <summary>API controller base class.</summary>
[ApiController]
public abstract class GortControllerBase : ControllerBase
{
...
[Route("api/health")]
public sealed class HealthController : GortControllerBase
{
...
[Route("api/disks")]
public sealed class DisksController : GortControllerBase
{
...
[Route("api/shares")]
public sealed class SharesController : GortControllerBase
{
...
[Route("api/snapshots")]
public sealed class SnapshotsController : GortControllerBase
{
...
[Route("api/recycle")]
public sealed class RecycleController : GortControllerBase
{
...
[Route("api/agents")]
public sealed class AgentsController : GortControllerBase
{
...
public sealed class AgentLogsController : GortControllerBase
{
...
[Route("api/services")]
public sealed class ServicesController : GortControllerBase
{
...
[Route("api/logs")]
public sealed class LogsController : GortControllerBase
{
...
[Route("api/audit")]
public sealed class AuditController : GortControllerBase
{
...
[Route("api/metrics")]
public sealed class MetricsController : GortControllerBase
{
...
[Route("api/alerts")]
public sealed class AlertsController : GortControllerBase
{
...
[Route("api/ups")]
public sealed class UpsController : GortControllerBase
{
...
[Route("api/recovery")]
public sealed class RecoveryController : GortControllerBase
{
...
[Route("api/auth")]
public sealed class AuthController : GortControllerBase
{
...
[Route("api/config")]
public sealed class ConfigController : GortControllerBase
{
