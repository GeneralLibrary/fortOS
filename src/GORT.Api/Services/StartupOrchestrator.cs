...
public sealed class StartupOrchestrator : IHostedService
{
    ...
    private async Task RunAsync(CancellationToken ct)
    {
        try
        {
            ...
            logger.LogInformation("GORT API startup orchestration completed.");
        }
        ...
        {
            logger.LogWarning(ex, "GORT API startup orchestration failed, service will continue running in degraded mode.");
        }
    }
}
