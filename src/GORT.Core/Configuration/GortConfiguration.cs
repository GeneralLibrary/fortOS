...
/// <summary>
/// YAML file-based GORT configuration reader.
/// </summary>
public sealed class GortConfiguration : IGortConfiguration
{
    ...
    /// </summary>
    /// <param name="configPath">Configuration file path; if empty, reads GORT_CONFIG_PATH or uses the default path.</param>
    public GortConfiguration(string? configPath = null)
    {
        var path = string.IsNullOrWhiteSpace(configPath)
            ? Environment.GetEnvironmentVariable("GORT_CONFIG_PATH")
            : configPath;
