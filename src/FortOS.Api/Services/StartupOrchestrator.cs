...
public sealed class StartupOrchestrator : IHostedService
{
    ...
    private async Task RunAsync(CancellationToken ct)
    {
        try
        {
            ...
            logger.LogInformation("FortOS API startup orchestration completed.");
        }
        ...
        {
            logger.LogWarning(ex, "FortOS API startup orchestration failed, service will continue running in degraded mode.");
        }
    }
}
