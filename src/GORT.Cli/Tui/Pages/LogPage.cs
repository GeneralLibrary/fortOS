...
public sealed class LogPage : ITuiPage
{
    ...
    /// <inheritdoc />
    public Task<bool> HandleKeyAsync(ConsoleKeyInfo key, GortApiClient client, CancellationToken cancellationToken)
    {
        var map = new Dictionary<char, string> { ['S'] = "System", ['A'] = "Audit", ['C'] = "Container", ['G'] = "Gort", ['T'] = "Task", ['M'] = "Metrics" };
