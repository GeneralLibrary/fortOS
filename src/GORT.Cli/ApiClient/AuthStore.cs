...
/// <summary>Manages local GORT CLI authentication data.</summary>
public sealed class AuthStore
{
    ...
    public static string ConfigPath => Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.UserProfile), ".gort", "config.json");
