...
/// <summary>
/// YAML file-based FortOS configuration reader.
/// </summary>
public sealed class FortOSConfiguration : IFortOSConfiguration
{
    ...
    /// </summary>
    /// <param name="configPath">Configuration file path; if empty, reads FortOS_CONFIG_PATH or uses the default path.</param>
    public FortOSConfiguration(string? configPath = null)
    {
        var path = string.IsNullOrWhiteSpace(configPath)
            ? Environment.GetEnvironmentVariable("FortOS_CONFIG_PATH")
            : configPath;
