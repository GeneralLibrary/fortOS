...
/// <summary>
/// GORT identity authentication service.
/// </summary>
public sealed class IdentityService : IIdentityService
{
    ...
    public IdentityService(IDatabaseProvider database, ITokenManager tokenManager, IGortConfiguration? configuration = null, IEnumerable<ISystemUserProvisioner>? provisioners = null, ILogger<IdentityService>? logger = null)
    {
        _database = database;
...
""";
    ...
    /// <summary>Invokes all system user provisioners; individual failures are only logged as warnings and do not affect the GORT internal user creation result.</summary>
