<!--
  GNAS Dashboard — 极空间-style Application Shell
...
/** Page title — prefer explicit route meta, fall back to nav label, then 'GNAS'. */
const pageTitle = computed(() => {
  ...
  return navMap[routeName] ? t(navMap[routeName]) : 'GNAS'
})
