...
> 🙏 **致敬原作者:orcastor(汪汪队射手)**
>
> 本文件夹收录的是开源项目 **OrcaS 3D打印外壳** 的完整设计稿(含 STL 模型、BOM 表、装机文档),内容与原作者仓库保持一致。该设计是 QNAS MINI 的改进衍生版本,感谢作者在硬件选型、背板方案、打印参数上的无私分享!
>
> - 📦 **源项目地址:** https://github.com/orcastor/case
> - 🎬 **原作者 B站空间:** https://space.bilibili.com/300702869
> - 📄 **许可证:** MIT License(见 [LICENSE](./LICENSE))
>
> 如果本设计对你有帮助,请前往源仓库点个 Star 支持原作者。
...
## 总成本
 ...
 打印件成本￥64.8 + 采购件成本￥688.8 + 存储成本￥480 \~ 2370 = ￥1233.6 \~ 3123.6
